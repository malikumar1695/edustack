...
/**
 * The current user's access; an empty string means not logged in
 * current user access， if is '', user need login
 * If this is a Pro preview, access is granted by default
 */
...
// The code is compatible with both local service mocks and static data on deployed sites
export default {
  // Supports both Object and Array values
